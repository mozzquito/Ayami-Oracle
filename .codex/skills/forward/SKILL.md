...
name: forward
description: '[standard] v26.8.23-alpha.2112 L-SKLL | Hand off the current session to the next one. Use when user says "forward", "handoff", "wrap up", or before ending a session.'
